...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'generate-cityscapes-sbd-gt = pyEdgeEval.scripts.convert_datasets.cityscapes:main',
            'generate-cityscapes-hed-gt = pyEdgeEval.scripts.convert_datasets.cityscapes_hed:main',
        ],
    },
)